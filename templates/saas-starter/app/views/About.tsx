    ...
    <AnimatePresence>
      ...
      >
        <div className="py-8">
          <div>{props.title}</div>
          <p>
            Gemi, is a batteries included framework for building web
            applications. You can create server side rendered applications and
            create APIs.
          </p>
          <br />
          <p>
            It also provides wide range of features like authentication,
            authorization, database support, file uploads, email sending, etc.
            out of the box.
          </p>
          <br />
          It runs on{" "}
