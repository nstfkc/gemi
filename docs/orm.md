...
**Not implemented yet:** ordering by a relation, and filtering across an implicit many-to-many.
Both raise `UnsupportedQueryError` rather than being silently ignored.
